  ...
  form.submit(function () {
    ...
    $.post($(this).attr('action'),
      ...
      function () {
        ...
        $('#contact-message')
          .html('<div class="alert alert-success" role="alert"><button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>Votre message a bien été envoyé. Nous vous répondrons dans les plus brefs délais.</div>')
          .fadeIn()
      }
      , 'json')
    return false
